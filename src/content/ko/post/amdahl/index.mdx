...
뉴스레터 구독자수를 알아내기 위해 <a href="https://resend.com">resend</a>를 사용하는데, 여기로 보낸 api 요청이 1초가 넘게 걸렸습니다. 즉 아래 텍스트가 원인이었던 것이죠:

<blockquote><SubscriberCount />명과 함께합니다.</blockquote>
...
<AmdahlLawExample client:load lang="ko" />
