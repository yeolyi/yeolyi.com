---
title: Trigger, Schedule, Render, Commit
order: 1
category: prepare
---
...
샌박 관련된 함수는 무시하고 리액트 스크립트쪽 함수들만 살펴보자. (<a href="/ko/react/setup">리액트 초기 설정</a> 게시물을 참고해 직접 로컬에서 확인해봐도 좋다. 이러면 샌박 관련 함수들이 없어져 콜스택이 좀 더 깔끔해진다.)
