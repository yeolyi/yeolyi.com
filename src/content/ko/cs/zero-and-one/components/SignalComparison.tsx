...
const SignalVisualizer: React.FC<SignalVisualizerProps> = ({
  ...
  return (
    <div className="relative mb-4 h-48 border text-xs">
      {/* 유효 범위 상한선 */}
      <div
        className="absolute left-0 z-10 w-full border-t-1 border-white"
      ...
      <CardContent>
        <div className="flex flex-col items-start gap-6 md:flex-row">
          <div className="w-full md:w-1/2">
            <p className="mb-2">
              디지털 신호{" "}
              <span className="text-muted-foreground">목표값 1</span>
            </p>
          ...
          <div className="w-full md:w-1/2">
            <p>
              아날로그 신호{" "}
              <span className="text-muted-foreground">목표값 5</span>
            </p>
