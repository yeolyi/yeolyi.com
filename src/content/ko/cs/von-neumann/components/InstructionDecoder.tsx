...
export function InstructionDecoder({ lang }: { lang: string }) {
  const t = useTranslations(lang)("VonNeumann").InstructionDecoder;
  const tSet = useTranslations(lang)("VonNeumann").InstructionSetTable;
  const tSim = useTranslations(lang)("VonNeumann").Simulator;
