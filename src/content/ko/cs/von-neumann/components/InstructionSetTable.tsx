...
export function InstructionSetTable({ lang }: { lang: string }) {
  const t = useTranslations(lang)("VonNeumann").InstructionSetTable;
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <div className="border-border flex h-10 w-full border">
                    {details.structure.map((part, idx) => (
                      <div
                        key={idx}
                        className={`flex flex-col items-center justify-center p-1 text-center text-xs ${part.bits === 4 ? "w-1/2" : "w-1/4"} ${idx > 0 ? "border-border border-l" : ""}`}
                      >
                ...
                <div>
                  ...
                  <pre className="bg-muted p-3 leading-relaxed">
                    <code>
                      {details.example}
                      <br />
