...
export default function EdgeTriggerDemo({ lang }: { lang: string }) {
  const t = useTranslations(lang)("Sequential").EdgeTriggerDemo;
  const {
    clock,
    history,
    risingActive,
        ...
        <CardDescription>
          <p>
            <span
              className={clsx(
                "text-base",
                risingActive && "font-bold text-green-400",
              )}
            >
              {t.risingEdge}
            </span>
            ...
            <span
              className={clsx(
                "text-base",
                fallingActive && "font-bold text-green-400",
              )}
            >
              {t.fallingEdge}
            </span>
