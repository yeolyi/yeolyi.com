...
export default function ClockSyncVisualizer({ lang }: { lang: string }) {
  const t = useTranslations(lang)("Sequential").ClockSyncVisualizer;
      ...
      <CardContent className="flex flex-col items-center gap-6">
        <div className="flex flex-wrap items-center justify-center gap-2">
          {values.map((val, i) => {
            ...
            return (
              <Fragment key={i}>
                <div className="bg-muted flex min-h-[80px] min-w-[140px] flex-col items-center justify-center p-4 text-center">
