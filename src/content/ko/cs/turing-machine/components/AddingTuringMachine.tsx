...
const AddingTuringMachineContent = ({ lang }: { lang: string }) => {
  ...
  return <Tape tape={tape} head={headIdx} currentState={state} lang={lang} />;
};

export default function AddingTuringMachine({ lang }: { lang: string }) {
  const t = useTranslations(lang)("CS");
  ...
  return (
    <Card>
      ...
      <CardContent>
        <TuringMachineProvider>
          <AddingTuringMachineContent lang={lang} />
        </TuringMachineProvider>
      </CardContent>
    </Card>
  );
