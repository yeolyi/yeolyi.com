...
description: '간단한 함수 하나로 컴퓨터의 모든걸 만들 수 있음을 확인해봅시다'
order: 3
category: 'hardware'
---
...
<Flow id="not_answer" initialJSON={not} client:idle/>
...
<Flow id="and_playground" client:idle/>

<br/>

<details>
<summary>예시 답안 보기</summary>
<Flow id="and_answer" initialJSON={and} client:idle/>
...
<Flow id="or_answer" initialJSON={or} client:idle/>
