---
title: 'Avoiding Futile Optimizations'
date: 2025-07-20
---

import Flow from '@/components/cs/flow';
import not from '@/content/ko/cs/nand-is-all-you-need/assets/not.json';
import SubscriberCount from '@/components/Main/ResendSubscriberCount.astro';
import AmdahlLawExample from '../../ko/post/amdahl/components/AmdahlLawExample';
...
![](@/content/ko/post/amdahl/assets/screenshot.png)
...
<Flow id='/cs' initialJSON={not} height={250} hideNodeButtons client:load />
...
I use <a href="https://resend.com">resend</a> to get the newsletter subscriber count, and the API request to it took over 1 second. In other words, this text was the cause:

<blockquote><SubscriberCount />people are joining us!</blockquote>
...
<AmdahlLawExample client:load lang="en" />
