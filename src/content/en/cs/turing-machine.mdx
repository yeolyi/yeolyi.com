---
title: "If All It Does Is Math, It's Just a Calculator"
description: "Let's explore the fundamental difference between computers and other tools"
order: 6
category: "hardware"
---

import abacus from '@/content/ko/cs/turing-machine/assets/abacus.png';
import tools from '@/content/ko/cs/turing-machine/assets/tools.png';
import vonNeumann from '@/content/ko/cs/turing-machine/assets/von-neumann.png';
import entscheidungsproblem from '@/content/ko/cs/turing-machine/assets/entscheidungsproblem.png';
import TuringMachine from '@/content/ko/cs/turing-machine/components/TuringMachine';
