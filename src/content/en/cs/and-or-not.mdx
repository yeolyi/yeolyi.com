---
title: "Computers are Built on Simple Logical Decisions: AND, OR, and NOT Gates"
description: "Let's confirm that all boolean functions in the world can be expressed with AND, OR, and NOT gates."
order: 2
category: "hardware"
---
...
import circuit from '@/content/ko/cs/and-or-not/assets/circuit.jpg';
import lego from '@/content/ko/cs/and-or-not/assets/lego.jpg';
