---
title: "Ask von Neumann About Computer Assembly"
description: "The simple yet powerful idea of 'storing programs in the same space as data.' Let's explore how this single concept created the basic framework of modern computers: CPU, memory, and bus."
order: 7
category: "hardware"
---

import turingMachine from '@/content/ko/cs/von-neumann/assets/turing-machine.png';
import vonNeumann from '@/content/ko/cs/von-neumann/assets/von-neumann.png';
import vonNeumannDiagram from '@/content/ko/cs/von-neumann/assets/von-neumann-diagram.png';
import { Memory } from '@/content/ko/cs/von-neumann/components/Memory';
import { InstructionDecoder } from '@/content/ko/cs/von-neumann/components/InstructionDecoder';
import { InstructionSetTable } from '@/content/ko/cs/von-neumann/components/InstructionSetTable';
import { MonitorSimulator } from '@/content/ko/cs/von-neumann/components/MonitorSimulator';
import { VonNeumannSimulator } from '@/content/ko/cs/von-neumann/components/VonNeumannSimulator';
...
<InstructionSetTable lang="en" client:idle/>
...
<InstructionDecoder lang="en" client:idle/>
...
<MonitorSimulator lang="en" client:idle/>
...
<VonNeumannSimulator lang="en" client:idle/>
