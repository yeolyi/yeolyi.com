---
title: "The computer that didn’t quite like both mom and dad"
description: "Let’s see how we can create everything in computing from just one simple function"
order: 3
category: "hardware"
---
...
import not from '../../ko/cs/nand-is-all-you-need/assets/not.json';
import and from '../../ko/cs/nand-is-all-you-need/assets/and.json';
import or from '../../ko/cs/nand-is-all-you-need/assets/or.json';
...
<Flow id="not_answer" initialJSON={not} lang="en" client:idle/>
...
<Flow id="and_playground" lang="en" client:idle/>

<br/>

<details>
<summary>View Example Solution</summary>
<Flow id="and_answer" initialJSON={and} lang="en" client:idle/>
...
<Flow id="or_answer" initialJSON={or} lang="en" client:idle/>
