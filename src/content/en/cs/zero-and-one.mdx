---
title: "Why Computers Only Have Two Fingers"
description: "Explore how just two numbers, 0 and 1, become the building blocks for sounds, texts, images, and virtually everything we can imagine."
order: 1
category: "hardware"
---

import PixelateImage from "../../ko/cs/zero-and-one/components/PixelateImage";
import SignalComparison from "../../ko/cs/zero-and-one/components/SignalComparison";
import TruthTable from "@/components/cs/TruthTable";

import zeroone from "@/content/ko/cs/zero-and-one/assets/zeroone.png";
import painting from "@/content/ko/cs/zero-and-one/assets/painting.png";
import lp from "@/content/ko/cs/zero-and-one/assets/lp.png";
import shannon from "@/content/ko/cs/zero-and-one/assets/shannon.png";
...
<SignalComparison client:idle lang="en"/>
...
![](@/content/ko/cs/zero-and-one/assets/shannon.png)
