---
title: "Now You Can Build Calculators (For Real)"
description: "Let's create circuits that can perform addition using NAND gates"
order: 4
category: "hardware"
---
...
import DecimalToBinary from "../../ko/cs/adder/components/DecimalToBinary";

import calculator from "@/content/ko/cs/adder/assets/calculator.png";
import halfNand from "@/content/ko/cs/adder/assets/halfNand.json";
import half from "@/content/ko/cs/adder/assets/half.json";
import full from "@/content/ko/cs/adder/assets/full.json";
...
<DecimalToBinary lang="en" client:idle/>
...
<Flow id="half" initialJSON={half} lang="en" client:idle/>
...
<Flow id="half-nand" initialJSON={halfNand} lang="en" client:idle/>
...
<Flow id="half-to-full" initialJSON={full} lang="en" client:idle/>
...
<Flow id="ripple-carry-adder" initialJSON={ripple} height={500} lang="en" client:idle/>
