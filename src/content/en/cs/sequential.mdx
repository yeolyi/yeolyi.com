---
title: "Fixing the Computer with Amnesia"
description: "Going beyond the limitations of combinational logic circuits that forget calculation results, we explore the fundamental principles of sequential logic circuits and memory that enable computers to 'remember' information."
order: 5
category: "hardware"
---
...
import srLatch from '@/content/ko/cs/sequential/assets/srLatch.json';
import dLatch from '@/content/ko/cs/sequential/assets/dLatch.json';
import CombVsSeq from '@/content/ko/cs/sequential/components/CombVsSeq';
import ClockSyncVisualizer from '@/content/ko/cs/sequential/components/ClockSyncVisualizer';
import EdgeTriggerDemo from '@/content/ko/cs/sequential/components/EdgeTriggerDemo';
import dFlipFlop from '@/content/ko/cs/sequential/assets/dFlipFlop.json';
...
<ClockSyncVisualizer lang="en" client:idle/>
...
<EdgeTriggerDemo lang="en" client:idle/>
